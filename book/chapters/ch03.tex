...
\begin{itemize}[leftmargin=*]
  ...
  \item $s_2$: \textbf{Рутуб} --- browsing social media.
...
$s_1$ (Class) & distract & $s_2$ (Рутуб) & 1.0 & $-1$ \\
$s_2$ (Рутуб) & quit & $s_1$ (Class) & 1.0 & $-1$ \\
$s_2$ (Рутуб) & keep & $s_2$ (Рутуб) & 1.0 & $-1$ \\
...
\end{align*}
For $V_*(s_2)$ we note that from Рутуб the optimal action is \emph{quit} (returning to Class, which has value $7.0$), so:
\[
